    ...
    <nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Events<span class="caret"></span></a>
            	<ul class="dropdown-menu">
            		...
            		<li><a href="/event/search">Search Events</a></li>
            	</ul>
            </li>
          ...
          <p class="navbar-text"><a href="/event/search"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></p>
            <li class="dropdown">
