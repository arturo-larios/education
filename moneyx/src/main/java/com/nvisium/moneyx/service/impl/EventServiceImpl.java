...
public class EventServiceImpl implements EventService {
	...
	public List<Event> searchEventsByOwner(Long user, String q) {
		return eventRepository.searchEventsByUser(user, q);
	}
	
	//public List<Event> searchMembershipsByOwner(Long user, String q) {
	//	return eventMembershipRepository.findEventMembershipByUserId(user);
	//}
}
